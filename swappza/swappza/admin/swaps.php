...
<html>
    ...
    <body>
        ...
        <div class="backend-content-title-bar">
            <img class="backend-content-title-bar-icon" alt="swaps-icon" src="<?php echo $BACKEND_DOMAIN_BASE; ?>/images/Swap.png" />
        ...
        <script>
            var nonceToken = '<?php echo oab_create_nonce($mysqli, null, 'swaps.php'); ?>';
        </script>
