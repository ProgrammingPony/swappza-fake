...
<html>
    ...
    <body>
        ...
        <div class="backend-content-title-bar">
            <img class="backend-content-title-bar-icon" alt="settings-icon" src="<?php echo $BACKEND_DOMAIN_BASE; ?>/images/Settings_Icon.png" />
        ...
        <script>
            var nonceToken = '<?php echo oab_create_nonce($mysqli, null, 'settings.php'); ?>';
        </script>
